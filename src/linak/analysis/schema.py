...
_ANALYSIS_SCHEMAS: dict[str, AnalysisSchema] = {
    ...
    "orientation": AnalysisSchema(
        ...
        default_units_map={
            ...
            "grid_x_edges_A": "Angstrom",
            "grid_y_edges_A": "Angstrom",
            "grid_z_edges_A": "Angstrom",
            "grid_distance_edges_A": "Angstrom",
            "grid_flat_indices": "index",
            "grid_entity_sum": "counts",
            "grid_cos_polar_sum": "dimensionless",
            "grid_count_polar_valid": "counts",
            "grid_cos_azimuthal_sum": "dimensionless",
            "grid_count_azimuthal_valid": "counts",
            "surface_position_per_frame_A": "Angstrom",
            "surface_confidence": "dimensionless",
            "surface_largest_gap_A": "Angstrom",
            "surface_baseline_gap_A": "Angstrom",
